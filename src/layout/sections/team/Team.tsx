...
const teamItem = [
  { id: "team1", src: img1, name: "Камилла", text: "Старший мастер" },
  { id: "team2", src: img2, name: "Лариса", text: "Массажист" },
  { id: "team3", src: img3, name: "Полина", text: "Массажист" },
  { id: "team4", src: img4, name: "Максим", text: "Массажист" },
];
